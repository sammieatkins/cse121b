...
let info = {
    ...
    photo: "images/sammie.png",
    
    // Step 4: Add another property named favoriteFoods with a value of an array of your favorite foods as strings ( hint: [] )
    favoriteFoods: ["pizza","raspberries","popcorn"],

    // Step 5: Add another property named hobbies with a value of an array of your hobbies as strings
    hobbies: ["knitting","reading","minecraft"],
    ...
    placesLived: [
        ...
        {place: "Monroe, Louisiana", length: "2 years"},
        {place: "St. Louis, Missouri", length: "19 years"},
        {place: "Rexburg, Idaho", length: "10 months"}
    ]
}
...
document.querySelector("img").setAttribute("alt", info.name);
...
info.placesLived.forEach((place) =>
{
    ...
    placeLivedLength.textContent = place.length
